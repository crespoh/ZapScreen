...
DROP POLICY IF EXISTS "Users can view their own unlock requests" ON unlock_requests;
DROP POLICY IF EXISTS "Users can insert their own unlock requests" ON unlock_requests;
DROP POLICY IF EXISTS "Users can update their own unlock requests" ON unlock_requests;
