...
class ZapScreenManager {
    ...
    private let unlockEventURL = "https://droyecamihyazodenamj.functions.supabase.co/unlock-event"
    private let unlockCommandURL = "https://droyecamihyazodenamj.functions.supabase.co/unlock-command"
